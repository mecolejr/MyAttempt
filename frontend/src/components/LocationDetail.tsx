...
export default function LocationDetail({ id, onClose }: { id: number | null; onClose: () => void }) {
  ...
  return (
    <div style={{
      ...
      {loading && (
        <div>
          <div style={{ height: 16, width: 220, background: '#eee', borderRadius: 4, marginTop: 12 }} />
          <div style={{ height: 12, width: 160, background: '#eee', borderRadius: 4, marginTop: 8 }} />
          <div style={{ height: 8, width: 260, background: '#eee', borderRadius: 4, marginTop: 8 }} />
        </div>
      )}
